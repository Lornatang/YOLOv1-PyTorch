...
os.system("python ./convert_voc_to_yolo.py "
          ...
          "--input_annotations_dir ./VOCdevkit/VOC2007/Annotations "
          "--output_images_dir ./YOLO/images "
          "--output_annotations_dir ./YOLO/annotations "
          "--classes_txt_file_path ./voc_classes.txt "
          "--output_mode_dir ./YOLO "
          "--mode train")
...
os.system("python ./convert_voc_to_yolo.py "
          ...
          "--input_annotations_dir ./VOCdevkit/VOC2012/Annotations "
          "--output_images_dir ./YOLO/images "
          "--output_annotations_dir ./YOLO/annotations "
          "--classes_txt_file_path ./voc_classes.txt "
          "--output_mode_dir ./YOLO "
